/*
 * x.c -- wrapper routines for common syscalls for X and Windows
 *
...
/* asprintf - snprintf with allocation.  This implementation (to keep Windows
 * happy) has come partly from the Piglit project (c) 2007. */
